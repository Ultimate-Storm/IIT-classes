...
Figure \ref{fig:1-instr} shows the first instruction being executed. The data memory at address 0x00000001 houses the data holds the value 0xAAAAAAAA and register \$1 is loaded with the data 0xAAAAAAAA.
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{simulation/1-instr}
\caption{Instruction 1}
\label{fig:1-instr}
\end{figure}
