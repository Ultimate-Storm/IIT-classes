...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|l|}
		...
		\hline
		$000010_2$ & \texttt{--} & \texttt{andi}& \texttt{andi \$s6, \$s2, 00FF} \\
		\hline
		$000000_2$ & $000010_2$ & \texttt{or}& \texttt{or \$s8, \$s1, \$s2} \\
		\hline
		$000011_2$ & \texttt{--} & \texttt{ori}& \texttt{ori \$s7, \$s1, 00FF} \\
		\hline		
	\end{tabular}
...
Figure \ref{fig:8-instr} shows the eight instruction. The value of 0xFFFFFFFF in register \$s2 and 0xAAAAAAAA in register are nanded and the result of 0x55555555 is both accurate and stored in register \$s5.
\begin{figure}[H]
\centering
