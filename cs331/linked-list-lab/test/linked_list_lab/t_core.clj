...
(facts "about `delete`"
    (let [nulist (List. (Cons. 3 (Cons. 2 (Cons. 1 nil)))3) ]
       (fact "it deletes data"
      (delete 2 nulist) => (List. (Cons. 3 (Cons. 1 nil)) 2))
      (delete 7 nulist) => nulist))


(facts "about `delete-all`"
  (let [nulist (List. (Cons. 3 (Cons. 3 (Cons. 2 nil))) 3) ]
    (fact "deletes all elements in a list"
     (delete-all 3 nulist) => (List. (Cons. 2 nil) 1)
    (delete-all 7 nulist) => nulist)))
